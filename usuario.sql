...
CREATE USER 'mauricio'@'localhost' IDENTIFIED BY '12345';
SHOW GRANTS FOR 'mauricio'@'localhost';

GRANT SELECT ON appmovie.* TO 'mauricio'@'localhost';
SHOW GRANTS FOR 'mauricio'@'localhost';
FLUSH PRIVILEGES;

GRANT SELECT ON appmovie.filme TO 'mauricio'@'localhost';
SHOW GRANTS FOR 'mauricio'@'localhost';
FLUSH PRIVILEGES;	

REVOKE SELECT ON appmovie.filme FROM 'mauricio'@'localhost';
